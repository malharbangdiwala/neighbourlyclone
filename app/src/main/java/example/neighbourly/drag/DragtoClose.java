package example.neighbourly.drag;
...
import example.neighbourly.R;

public class DragtoClose extends FrameLayout {
    private example.neighbourly.drag.DragListener listener;
...
//                Intrinsics.throwUninitializedPropertyAccessException("draggableView");
    ...
    public final void setDragListener(example.neighbourly.drag.DragListener listener) {
...
//            Intrinsics.throwUninitializedPropertyAccessException("draggableContainer");
    ...
    public final void onStartDraggingView() {
        example.neighbourly.drag.DragListener var10000 = this.listener;
        if (var10000 != null) {
...
//                throw (Throwable)(new IllegalArgumentException("draggableView and draggableContainer attributes are required."));
    ...
    private final void initViewDragHelper() {
        ...
        example.neighbourly.drag.DragHelperCallback var10003 = new example.neighbourly.drag.DragHelperCallback(this, var10006);
